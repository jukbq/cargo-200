$(document).ready(function() {
    ...
    let lossesArr = [
        { img: 'img/icon/1.png', name: 'Танки ', number: 1759 },
        { img: 'img/icon/2.png', name: 'Бронемашини', number: 3995 },
        { img: 'img/icon/3.png', name: 'Артелерійські системи', number: 906 },
        ...
        { img: 'img/icon/8.png', name: 'Автомобільна техніка і цистерни', number: 2889 },
        { img: 'img/icon/9.png', name: 'Кораблі (катери)', number: 15 },
        { img: 'img/icon/10.png', name: 'Крилаті ракети', number: 174 },
        { img: 'img/icon/12.png', name: 'БПЛА', number: 733 },
        { img: 'img/icon/11.png', name: 'Спецтехніка', number: 78 },
    ];
