$(document).ready(function() {
    ...
    let lossesArr = [
        { img: 'img/icon/1.png', name: 'Танки ', number: 1730 },
        { img: 'img/icon/2.png', name: 'Бронемашини', number: 3950 },
        { img: 'img/icon/3.png', name: 'Артелерійські системи', number: 876 },
        { img: 'img/icon/4.png', name: 'Системи залпового вогню', number: 257 },
        { img: 'img/icon/5.png', name: 'Засоби ППО', number: 116 },
        { img: 'img/icon/6.png', name: 'Літаки', number: 222 },
        { img: 'img/icon/7.png', name: 'Гелікоптери', number: 188 },
        { img: 'img/icon/8.png', name: 'Автомобільна техніка і цистерни', number: 2832 },
        { img: 'img/icon/9.png', name: 'Кораблі (катери)', number: 15 },
        { img: 'img/icon/10.png', name: 'Крилаті ракети', number: 174 },
        { img: 'img/icon/12.png', name: 'БПЛА', number: 719 },
