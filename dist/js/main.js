$(document).ready(function() {
    ...
    let lossesArr = [
        { img: 'img/icon/1.png', name: 'Танки ', number: 1684 },
        { img: 'img/icon/2.png', name: 'Бронемашини', number: 3879 },
        { img: 'img/icon/3.png', name: 'Артелерійські системи', number: 846 },
        { img: 'img/icon/4.png', name: 'Системи залпового вогню', number: 248 },
        { img: 'img/icon/5.png', name: 'Засоби ППО', number: 110 },
        { img: 'img/icon/6.png', name: 'Літаки', number: 220 },
        { img: 'img/icon/7.png', name: 'Гелікоптери', number: 188 },
        { img: 'img/icon/8.png', name: 'Автомобільна техніка і цистерни', number: 2746 },
        { img: 'img/icon/9.png', name: 'Кораблі (катери)', number: 15 },
        { img: 'img/icon/10.png', name: 'Крилаті ракети', number: 166 },
        { img: 'img/icon/12.png', name: 'БПЛА', number: 688 },
        { img: 'img/icon/11.png', name: 'Спецтехніка', number: 68 },
    ];
