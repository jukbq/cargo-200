$(document).ready(function() {
    ...
    let lossesArr = [
        { img: 'img/icon/1.png', name: 'Танки ', number: 1573 },
        { img: 'img/icon/2.png', name: 'Бронемашини', number: 3726 },
        { img: 'img/icon/3.png', name: 'Артелерійські системи', number: 790 },
        { img: 'img/icon/4.png', name: 'Системи залпового вогню', number: 246 },
        { img: 'img/icon/5.png', name: 'Засоби ППО', number: 104 },
        { img: 'img/icon/6.png', name: 'Літаки', number: 217 },
        { img: 'img/icon/7.png', name: 'Гелікоптери', number: 185 },
        { img: 'img/icon/8.png', name: 'Автомобільна техніка і цистерни', number: 2602 },
        { img: 'img/icon/9.png', name: 'Кораблі (катери)', number: 14 },
        { img: 'img/icon/10.png', name: 'Крилаті ракети', number: 143 },
        { img: 'img/icon/12.png', name: 'БПЛА', number: 641 },
